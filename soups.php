...
<body>
  <div class="parallax-container">
    <div class="parallax"><img src="img/soup-main.jpg"></div>
        ...
        <!-- soup -->
        <div class="container">
        <h1 id="soups" class="soup orange-text text-darken-4">Soups</h1>
        ...
        <section class="section">
            <div class="container">
                <h3 class="orange-text text-darken-4 center"> Soups </h3>
                <div class="row">
                    ...
                    <div class="col s12 m6 l4"> 
                        <div class="card hoverable">
                            ...
                            <div class="card-action center-align">
                                ...
                                <a href="" class="orange-text text-darken-4">COOK</a>
                            </div>
                        </div>
                    </div>
                    <?php };?>
