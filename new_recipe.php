...
if(isset($_POST['submit'])){
  ...
  // write query
  $save_query = "INSERT INTO `recipes_tb`(`recipe_name`, `recipe_type`, `description`, `ingredients`, `duration`, `primary_color`) VALUES ('$recipe_name','$recipe_type','$description','$ingredients','$duration','$primary_color)";
  // send to server
          ...
          <form action="new_recipe.php" method="post">
            ...
            <div class="row">
              ...
              <div class="col s12 l2 input-field">
                <textarea id="primary_color" name="primary_color" class="materialize-textarea"></textarea>
